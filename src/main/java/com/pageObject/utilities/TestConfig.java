...
public class TestConfig{
	...
	public static String from = "jimmyporwal245@gmail.com";
	public static String password = "jimmy22081997";
	public static String[] to ={"namanporwal2@gmail.com","trainer@way2automation.com"};
